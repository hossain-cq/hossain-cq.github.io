...
<section id="about" class="section">
  ...
  <article class="card">
      ...
      <p>
        ...
        and subspace compression for chemistry problems, rather than
        hardware benchmarking for its own sake. The question I keep returning
        to is: what can a quantum algorithm do for a real chemical system that
        a classical method genuinely cannot?
      </p>
      <div class="card-footer">
